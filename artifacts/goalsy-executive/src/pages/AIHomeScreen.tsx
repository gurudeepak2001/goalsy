...
function pickPriorityGoal(goals: { id: string; name: string; type: string; targetAmount: number; currentAmount: number; monthlyContribution: number; createdAt: string; targetDate?: string | null; status: string; priority?: number }[] | undefined): PriorityItem | null {
